...
# To create custom data transformers,
# 1. Need to inherit BaseEstimator and TransformerMixin (imported from sklearn.base)
# 2. Implement fit and transform
# 3. Accept input with __init__ method
class MeanImputer(BaseEstimator,TransformerMixin):
    ...
    def fit(self,X,y=None):
        ...
        for col in self.variables:
            # Compute the mean of column and save it as key in dict
            self.mean_dict[col] = X[col].mean()
            # .fit always return self
        return self
